...
export const Messages = () => {
    ...
    <div>{onoff ? <div className="Collapsedmessage" onClick={()=>setOnoff(!onoff)} >
        ...
        : 
    <div className="Uncollapsedmessage" onClick={()=>setOnoff(!onoff)}>big div <i className="bi bi-three-dots"></i>  <i className="bi bi-pencil-square"></i> <i className="bi bi-caret-up"></i> </div>}
    </div>
