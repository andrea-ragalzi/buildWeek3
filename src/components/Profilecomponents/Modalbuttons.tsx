            ...
            <Modal show={show} onHide={handleClose} animation={false} size="lg"
                ...
                <Modal.Body>
                    <InputGroup>
                        ...
                        <input type="text" className="w-100" value={newProfile.name} onChange={(e) => setNewProfile({ ...newProfile, name: e.target.value })} />
                        <span className="text-muted">Cognome : </span>
                        <input type="text" className="w-100" value={newProfile.surname} onChange={(e) => setNewProfile({ ...newProfile, surname: e.target.value })} />
                        <span className="text-muted">Professione : </span>
                        <input type="text" className="w-100" value={newProfile.title} onChange={(e) => setNewProfile({ ...newProfile, title: e.target.value })} />
                        <span className="text-muted">Indirizzo : </span>
                        <input type="text" className="w-100" value={newProfile.area} onChange={(e) => setNewProfile({ ...newProfile, area: e.target.value })} />
